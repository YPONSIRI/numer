...
class App extends Component {
  ...
  render() {
    return (
      <Router>
        <Layout>
          <Header style={{ background: "#1488C5", color: "black" }} className="header">
            <div>
          ...
          <Content style={{ padding: '0 60px' }}>
            <Layout className="site-layout-background" style={{ padding: '24px 0' }}>
              <Sider className="site-layout-background" width={270} >
                ...
                >
                  ...
                  >
                    ...
                    <Menu.Item key="12"><CaretRightOutlined />LU </Menu.Item>
              ...
              <Content style={{ background: "#0a0a0a", color: "black", padding: '0 24px', minHeight: 750 }}>
